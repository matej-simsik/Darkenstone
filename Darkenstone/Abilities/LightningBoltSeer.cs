...
{
    public class LightningBoltSeer : Ability
    {
        private Character _character;

        public const string ConstructorName = "Lightning Bolt"; 
        public override string Name { get { return ConstructorName; } }
        public override string Description { get { return "Causes 0 - 300 damage."; } }
        ...
        {
            int finalDamage = Random.Next(0, 300);
